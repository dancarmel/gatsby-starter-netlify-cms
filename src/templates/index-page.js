              ...
              <div className="content">
                ...
                <div className="columns">
                  <div className="column is-12 has-text-centered">
                    <Link className="btn" to="/products" id="btn">
                      See all products
                    </Link>
                  </div>
                </div>
...
const IndexPage = ({ data }) => {
  ...
  return (
	...
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("ab-testing-client", [], factory);
	else if(typeof exports === 'object')
		exports["ab-testing-client"] = factory();
	else
		root["ab-testing-client"] = factory();
...
var _helpers = _interopRequireDefault(__webpack_require__(/*! ./helpers */ "./src/helpers/index.js"));
...
/*#__PURE__*/
function () {
  function AbTestingClient(TEST_ID) {
    _classCallCheck(this, AbTestingClient);

    this.room = TEST_ID;
    this.url = "".concat(_config.default.API_URL, "/api/users/sync?abtest=").concat(TEST_ID);
    this.conversionUrl = "".concat(_config.default.API_URL, "/api/users/converted");
    this.socket = (0, _socket.default)(_config.default.API_URL);
    this.currentClientId = _store.default.get('CURRENT_USER_ID');
    this.currentVariantId = _store.default.get('ABTEST_CURRENT_VARIANT_ID');
  }

  _createClass(AbTestingClient, [{
    key: "renderRightVariant",
    value: function renderRightVariant(nodeId, variantModel, status) {
      if (status === 'LIVE' && nodeId && variantModel.text) {
        _helpers.default.replaceDOM(nodeId, variantModel.text);
      }
    }
  }, {
    key: "init",
    value: function init() {
      ...
      fetch(this.url, {
        ...
        if (!_this.currentClientId) {
          _store.default.set('CURRENT_USER_ID', client._id);

          _this.currentClientId = client._id;
        }

        var _client$abtest = client.abtest,
            nodeId = _client$abtest.nodeId,
            conversionButtonId = _client$abtest.conversionButtonId,
            variants = _client$abtest.variants,
            status = _client$abtest.status;
        var variantModel = variants.filter(function (item) {
          return item._id === client.variant;
        })[0];

        if (_this.currentVariantId !== variantModel._id) {
          _this.currentVariantId = variantModel._id;

          _store.default.set('ABTEST_CURRENT_VARIANT_ID', variantModel._id);
        }

        _this.renderRightVariant(nodeId, variantModel, status);

        document.getElementById(conversionButtonId).addEventListener('click', function (e) {
          fetch(_this.conversionUrl, {
            headers: new Headers({
              'content-type': 'application/json',
              'User-Id': _this.currentClientId || ''
            })
          });
        });
      }).catch(function (err) {
      ...
      this.socket.on('connect', function () {
        ...
        _this.socket.emit('subscribe', _this.room);
      });
      this.socket.on(this.room, function (_ref) {
        var nodeId = _ref.nodeId,
            variants = _ref.variants,
            status = _ref.status;
        console.log('Update received');
        var variantModel = variants.filter(function (item) {
          return item._id === _this.currentVariantId;
        })[0];
...
exports.default = AbTestingClient;
...
exports.default = void 0;
var config = {
  API_URL: 'https://vast-peak-74749.herokuapp.com',
  TEST_ID: '5c44a7cb153ab64654016676'
};
var _default = config;
...
exports.default = void 0;
var _default = {
  replaceDOM: function replaceDOM(id, body) {
...
(function () {
  window.AbTestingClient = _Client.default;
})();
